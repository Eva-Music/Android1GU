...
public class CityNameFragment extends Fragment {
    ...
    public static CityNameFragment newInstance(int columnCount) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new MyCityNameRecyclerViewAdapter(CityRepository.ITEMS, mListener));
        }
        return view;
    }
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListFragmentInteraction(TheCity item);
    }
}
